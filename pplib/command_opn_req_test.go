...
func TestOpnRequest_Parse(t *testing.T) {
	t.Run("00", auxTestCommand_Parse("OPN00200", &OpnRequest{}, &OpnRequest{PsCom: 0}, false))
	...
	t.Run("Non OPN", auxTestCommand_Parse("XPN00200", &OpnRequest{}, &OpnRequest{PsCom: 0}, true))
	t.Run("Bad size", auxTestCommand_Parse("OPNAAA00", &OpnRequest{}, &OpnRequest{PsCom: 0}, true))
	t.Run("Bad psCom", auxTestCommand_Parse("OPN002AA", &OpnRequest{}, &OpnRequest{PsCom: 0}, true))
}
